...
The following parameters are required by this class:
    ...
    - name: The name of the ArchimedeanFamily solid. Options are "Cuboctahedron", "Icosidodecahedron", \
            "Truncated Tetrahedron", "Truncated Octahedron", "Truncated Cube", "Truncated Icosahedron", \
            "Truncated Dodecahedron", "Rhombicuboctahedron", "Rhombicosidodecahedron", "Truncated Cuboctahedron", \
            "Truncated Icosidodecahedron", "Snub Cuboctahedron", and "Snub Icosidodecahedron".
""",
)

CatalanFamily = TabulatedGSDShapeFamily.from_json_file(
    os.path.join(_DATA_FOLDER, "catalan.json"),
    classname="CatlanFamily",
    docstring="""The family of Catalan solids, also known as Archimedean duals (13 total).

The following parameters are required by this class:

    - name: The name of the CatalanFamily solid. Options are "Deltoidal Hexecontahedron", "DeltoidalIcositetrahedron", \
            "Disdyakis Dodecahedron", "Disdyakis Triacontahedron", "Pentagonal Hexecontahedron", \
            "Pentagonal Icositetrahedron", "Pentakis Dodecahedron", "Rhombic Dodecahedron", "Rhombic Triacontahedron", \
            "Triakis Octahedron", "Tetrakis Hexahedron", "Triakis Icosahedron", "Triakis Tetrahedron".
""",
)
...
The following parameters are required by this class:
    ...
    - name: The name of the JohnsonFamily solid. A full list is available in 
            ...
            should have the first character of each word capitalized, with spaces between words \
            (e.g. "Elongated Triangular Cupola"). Pyramids and dipyramids are named from their base \ 
            polygon (e.g. "Square Pyramid" or "Elongated Pentagonal Dipyramid").
""",
)
...
The following parameters are required by this class:
    ...
    - name: The name of the pyramid or dipyramid. Options are "Tetrahedron", "Square Pyramid", \
            "Pentagonal Pyramid", "Triangular Dipyramid", "Octahedron", and "Pentagonal Dipyramid".
""",
)
...
The following parameters are required by this class:
    ...
    - name: The name of the prism or antiprism. Options for prisms are "Triangular Prism, \
            "Cube", "Pentagonal Prism", "Hexagonal Prism", "Heptagonal Prism", "Octagonal Prism", \
            "Nonagonal Prism", and "Decagonal Prism". Options for antiprisms are "Octahedron", \
            "Square Antiprism", "Pentagonal Antiprism", "Hexagonal Antiprism", "Heptagonal Antiprism", \
            "Octagonal Antiprism","Nonagonal Antiprism", and "Decagonal Antiprism".
""",
)
