...
class Ellipsoid(Shape3D):
    ...
    def to_hoomd(self):
        ...
        * a (float):
            Half-axis of the Ellipsoid in the :math:`x` direction.
        * b (float):
            Half-axis of the Ellipsoid in the :math:`y` direction.
        * c (float):
            Half-axis of the Ellipsoid in the :math:`z` direction.
        * centroid (list(float))
